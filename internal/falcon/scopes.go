// Code generated from falcon_mcp/common/api_scopes.py; DO NOT EDIT.

package falcon

// apiScopeRequirements maps each Falcon API operation name to the API scopes it
// requires. Ported verbatim from the Python API_SCOPE_REQUIREMENTS map. Used to
// enrich 403 errors with the scopes the caller is likely missing.
var apiScopeRequirements = map[string][]string{
	...
	"api_preempt_proxy_post_graphql":          {"Identity Protection Entities:read", "Identity Protection Timeline:read", "Identity Protection Detections:read", "Identity Protection Assessment:read", "Identity Protection GraphQL:write"},
...
// RequiredScopes returns the API scopes required for operation, or nil if the
// operation is not in the scope map.
func RequiredScopes(operation string) []string {
	return apiScopeRequirements[operation]
}
